...
describe('Central de Atendimento ao cliente TAT', function() {
    ...
    it('envia o formuário com sucesso usando um comando customizado', () => {
        ...
        cy.contains('#firstName').type('Fulano')
        cy.contains('#lastName').type('Teste')
        cy.contains('#email').type('emails@fulanis.com.br')
        cy.contains('#phone').type('11999999999')
        cy.contains(textarea[id="open-text-area"]).type('Teste de preenchimento do campo de texto')
